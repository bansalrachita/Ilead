...
function validateContact(){
    ...
    var error = "Must be a numerical Value!";
    if (isNaN(contact)) {  	
    	document.getElementById("Contact1").innerHTML = error;
    	flag=false;
    }else{
...
<div class="container">
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-4 well well-sm" style="margin-left: 400px; ">
            ...
            <input class="form-control" name="email" placeholder="Email@ilead.com" type="email" required />
            ...
            <input class="form-control" name="contact" placeholder="Contact" id="Contact" type="text" maxlength="10" onkeyup="validateContact()" required />
            <span id="Contact1"></span><br/>
            Role<br/>
