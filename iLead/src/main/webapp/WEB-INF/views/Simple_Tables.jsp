...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Employee | Simple Tables</title>
    ...
    <body class="skin-black">
        ...
        <header class="header">
            <a href="${pageContext.request.contextPath}/Employee_Index" class="logo">
        ...
        <!-- Director App -->
        <script src="${pageContext.request.contextPath}/resources/js/Employee/app.js" type="text/javascript"></script>
    </body>
</html>
