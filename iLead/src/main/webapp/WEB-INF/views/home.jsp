...
<!--                     <form role="form" action="javascript:;" method="post" id="login-form"> -->
                        <div class="form-group">
                            ...
                            <form:input path="username" name="username" id="email" class="form-control" placeholder="Username" value="Ankit"/>
                            <form:errors path="username" cssStyle="color:#ff0000" />
<!--                             <input type="email" name="email" id="email" class="form-control" placeholder="Username"> -->
                        </div>
                        <div class="form-group">
                            <label for="key" class="sr-only">Password</label>
                            <form:input path="password" name="key" id="key" class="form-control" placeholder="Password" value="pass3"/>
