...
<head>
<meta charset="UTF-8">
<title>Manager | General UI</title>
<meta
		...
		<aside class="left-side sidebar-offcanvas">
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li><a
						href="${pageContext.request.contextPath}/Manager_Profile"> <i
							class="fa fa-gavel"></i> <span>Profile</span>
					</a></li>

					<li><a
						href="${pageContext.request.contextPath}/Manager_createQuiz">
							<i class="fa fa-globe"></i> <span>Create Quiz</span>
					</a></li>

					<li><a
						href="${pageContext.request.contextPath}/Manager_EmployeePerformance">
							<i class="fa fa-glass"></i> <span>View Employee
								Performance</span>
					</a></li>
				...
				<div class="row">
					<div class="col-md-2">
						<div class="stat">
							...
							<h5 class="stat-info">${user.projectName}</h5>
						</div>
					</div>
					<div class="col-md-2">
						<div class="stat">
						...
						<div class="panel-body">
							<div class="tab-content">
								...
								<div id="about" class="tab-pane"
									...
									<br /> <br /> <a class="btn btn-success" data-toggle="modal"
												...
												<form
													...
													<div class="modal-body">
														...
														<label for="Lastname"> Lastname</label> <input type="text"
															name="Lastname" /><br /> <br /> <label for="Age">Age
														</label> <input type="text" name="Age" /><br /> <br />
														<div class="form-group">
