...
<title>Error Update</title>
</head>
<body  onload="timer=setTimeout(function(){ window.location='${pageContext.request.contextPath}/Manager_createQuiz';}, 2000)">
<h1>User Your request could not be made at this time!</h1><br/>
</body>
</html>